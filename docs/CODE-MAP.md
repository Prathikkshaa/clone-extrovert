...
- `app/core/dashboard.service.ts` + `app/pages/dashboard/*` — protected **dashboard**: meetings/replies/clicks-led metric cards (opens shown muted/honest), deliverability health strip, empty state. (File 12)
