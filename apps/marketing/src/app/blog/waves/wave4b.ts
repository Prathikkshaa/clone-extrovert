  ...
  body: [
    ...
    { type: 'p', text: 'Signals for HVAC come in two flavors. The first is homeowner-side: something in the physical system or the paperwork is aging out. The second is business-side: property managers, small commercial landlords, and multi-site operators have their own tells.' },
    {
      ...
      rows: [
        ...
        ['Website missing NATE or EPA 608 certification mentions', 'Owner probably has certs but does not advertise them; you can', 'Firecrawl or manual crawl of site'],
    ...
    { type: 'ol', items: [
      ...
      'Layer a residential Google Places pull for homes and small multifamily buildings in the ZIPs you already service. Milo does this natively via Places discovery.',
...
const POST_3: WavePost = {
  ...
  body: [
    ...
    { type: 'h2', text: 'The signals that actually predict a job', id: 'signals' },
    {
      ...
      headers: ['Signal', 'What it tells you', 'Where to find it'],
      rows: [
        ['No 24/7 emergency phone number visible on homepage', 'A competitor is losing 2am calls. A property manager reading their site notices this fast', 'Firecrawl or manual crawl of local competitor sites'],
    ...
    { type: 'h2', text: 'FAQ', id: 'faq' },
    {
      ...
      items: [
        ...
        { q: 'Can Milo handle plumbing-specific enrichment?', a: 'Yes. Google Places for discovery, Firecrawl for site crawl including schema and phone-number extraction, LLM enrichment for tone and gap detection, and drafts sent from your own Gmail or Outlook with warm-up.' },
      ],
    },
  ],
};
  ...
  body: [
    ...
    { type: 'h2', text: 'FAQ', id: 'faq' },
    {
      ...
      items: [
        ...
        { q: 'Can Milo pull these signals automatically?', a: 'Milo\'s crawl step (Firecrawl-backed) covers schema presence, sitemap health, thin-content flags, and phone/CTA gaps. Core Web Vitals and backlink profile still route through their native APIs (PageSpeed Insights, Ahrefs).' },
      ],
    },
  ],
};
