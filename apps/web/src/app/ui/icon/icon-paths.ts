// Icon path registry — Lucide icon inner SVG (MIT, lucide.dev).
// WHY: lucide-angular caps its peer range at Angular 21.x but this app is on
// Angular 22, so the package install is blocked (File 16 §3 fallback). Instead we
// ship a tiny zero-dependency inline-SVG system: this registry holds the Lucide
// path data, and ui-icon renders it at a consistent size. One icon system
// everywhere; only the icons listed here ship (tree-shake-friendly).
//
// All Lucide icons share: viewBox 0 0 24 24, fill none, stroke currentColor,
// stroke-width 2, round caps/joins. Only the inner elements differ — stored here.
...
export const ICON_PATHS = {
  ...
  phone:
    '<path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.4z"/>',
